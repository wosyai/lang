...
@wosy_fn__706f696e7465722d636173742d61646472657373__7372632f6d61696e2e77__33323965326631396465376631643564346538393762323936633365323035303163386537373733623737643237333833383435663532653033376461313836__676c6f62616c5f6279746573 = internal global [4 x i8] zeroinitializer
...
define void @wosy_fn__706f696e7465722d636173742d61646472657373__7372632f6d61696e2e77__33323965326631396465376631643564346538393762323936633365323035303163386537373733623737643237333833383435663532653033376461313836__72756e() {
entry:
  %utf8_literal37 = alloca [16 x i8], align 1
  %utf8_literal30 = alloca [16 x i8], align 1
  %utf8_literal23 = alloca [16 x i8], align 1
  %utf8_literal = alloca [16 x i8], align 1
  %fourth = alloca i8, align 1
  %third = alloca i8, align 1
  %second = alloca i8, align 1
  %first = alloca i8, align 1
  %base = alloca i32, align 4
  store i32 ptrtoint (ptr @wosy_fn__706f696e7465722d636173742d61646472657373__7372632f6d61696e2e77__33323965326631396465376631643564346538393762323936633365323035303163386537373733623737643237333833383435663532653033376461313836__676c6f62616c5f6279746573 to i32), ptr %base, align 4
  %base1 = load i32, ptr %base, align 4
  %load_base = inttoptr i32 %base1 to ptr
  %load = load i8, ptr %load_base, align 1
  store i8 %load, ptr %first, align 1
  %base2 = load i32, ptr %base, align 4
  %offset_base = inttoptr i32 %base2 to ptr
  %offset = getelementptr inbounds i8, ptr %offset_base, i64 1
  %offset_address = ptrtoint ptr %offset to i32
  %load_base3 = inttoptr i32 %offset_address to ptr
  %load4 = load i8, ptr %load_base3, align 1
  store i8 %load4, ptr %second, align 1
  %base5 = load i32, ptr %base, align 4
  %offset_base6 = inttoptr i32 %base5 to ptr
  %offset7 = getelementptr inbounds i8, ptr %offset_base6, i64 2
  %offset_address8 = ptrtoint ptr %offset7 to i32
  %load_base9 = inttoptr i32 %offset_address8 to ptr
  %load10 = load i8, ptr %load_base9, align 1
  store i8 %load10, ptr %third, align 1
  %base11 = load i32, ptr %base, align 4
  %offset_base12 = inttoptr i32 %base11 to ptr
  %offset13 = getelementptr inbounds i8, ptr %offset_base12, i64 3
  %offset_address14 = ptrtoint ptr %offset13 to i32
  %load_base15 = inttoptr i32 %offset_address14 to ptr
  %load16 = load i8, ptr %load_base15, align 1
  store i8 %load16, ptr %fourth, align 1
  %first17 = load i8, ptr %first, align 1
  ...
  %call18 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %call)
  ...
  %call19 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %utf8_literal)
  %second20 = load i8, ptr %second, align 1
  %call21 = call ptr @wosy_generic____(i8 %second20)
  %call22 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %call21)
  %data24 = getelementptr inbounds i8, ptr %utf8_literal23, i8 0
  store i32 ptrtoint (ptr @wosy_utf8_literal_1 to i32), ptr %data24, align 4
  %length25 = getelementptr inbounds i8, ptr %utf8_literal23, i8 8
  store i64 1, ptr %length25, align 4
  %call26 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %utf8_literal23)
  %third27 = load i8, ptr %third, align 1
  %call28 = call ptr @wosy_generic____(i8 %third27)
  %call29 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %call28)
  %data31 = getelementptr inbounds i8, ptr %utf8_literal30, i8 0
  store i32 ptrtoint (ptr @wosy_utf8_literal_2 to i32), ptr %data31, align 4
  %length32 = getelementptr inbounds i8, ptr %utf8_literal30, i8 8
  store i64 1, ptr %length32, align 4
  %call33 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %utf8_literal30)
  %fourth34 = load i8, ptr %fourth, align 1
  %call35 = call ptr @wosy_generic____(i8 %fourth34)
  %call36 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %call35)
  %data38 = getelementptr inbounds i8, ptr %utf8_literal37, i8 0
  store i32 ptrtoint (ptr @wosy_utf8_literal_3 to i32), ptr %data38, align 4
  %length39 = getelementptr inbounds i8, ptr %utf8_literal37, i8 8
  store i64 1, ptr %length39, align 4
  %call40 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %utf8_literal37)
  ret void
}
...
define i32 @main() {
entry:
  %array_literal = alloca [4 x i8], align 1
  %array_element = getelementptr inbounds [4 x i8], ptr %array_literal, i32 0, i32 0
  store i8 10, ptr %array_element, align 1
  %array_element1 = getelementptr inbounds [4 x i8], ptr %array_literal, i32 0, i32 1
  store i8 20, ptr %array_element1, align 1
  %array_element2 = getelementptr inbounds [4 x i8], ptr %array_literal, i32 0, i32 2
  store i8 30, ptr %array_element2, align 1
  %array_element3 = getelementptr inbounds [4 x i8], ptr %array_literal, i32 0, i32 3
  store i8 40, ptr %array_element3, align 1
  %struct_value = load [4 x i8], ptr %array_literal, align 1
  store [4 x i8] %struct_value, ptr @wosy_fn__706f696e7465722d636173742d61646472657373__7372632f6d61696e2e77__33323965326631396465376631643564346538393762323936633365323035303163386537373733623737643237333833383435663532653033376461313836__676c6f62616c5f6279746573, align 1
  call void @wosy_fn__706f696e7465722d636173742d61646472657373__7372632f6d61696e2e77__33323965326631396465376631643564346538393762323936633365323035303163386537373733623737643237333833383435663532653033376461313836__72756e()
  ret i32 0
}
