...
define void @wosy_fn__706f696e7465722d636173742d636865636b6564__7372632f6d61696e2e77__30613230343433643362333434356136663938666232656564353261383231383861373633306235653561316362333635373438353966343261316164333861__72756e() {
entry:
  %utf8_literal29 = alloca [16 x i8], align 1
  ...
  %allocation = call ptr @__wosy_core_alloc(i64 2, i64 1)
  ...
  store i32 %storage1, ptr %writer, align 4
...
deref_null_continue:                              ; preds = %entry
  ...
  store i32 %storage4, ptr %shared, align 4
  %shared5 = load i32, ptr %shared, align 4
  %deref_is_null6 = icmp eq i32 %shared5, 0
  br i1 %deref_is_null6, label %deref_null_panic7, label %deref_null_continue8

deref_null_panic7:                                ; preds = %deref_null_continue
  call void @__wosy_core_system_panic()
  unreachable

deref_null_continue8:                             ; preds = %deref_null_continue
  %deref9 = inttoptr i32 %shared5 to ptr
  %place = load i8, ptr %deref9, align 1
  store i8 %place, ptr %first, align 1
  %first10 = load i8, ptr %first, align 1
  ...
  %call11 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %call)
  ...
  %call12 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %utf8_literal)
  store i8 67, ptr %assignment_value13, align 1
  %assignment_value14 = load i8, ptr %assignment_value13, align 1
  %writer15 = load i32, ptr %writer, align 4
  %deref_is_null16 = icmp eq i32 %writer15, 0
  br i1 %deref_is_null16, label %deref_null_panic17, label %deref_null_continue18

deref_null_panic17:                               ; preds = %deref_null_continue8
  call void @__wosy_core_system_panic()
  unreachable

deref_null_continue18:                            ; preds = %deref_null_continue8
  %deref19 = inttoptr i32 %writer15 to ptr
  store i8 %assignment_value14, ptr %deref19, align 1
  %writer20 = load i32, ptr %writer, align 4
  %deref_is_null21 = icmp eq i32 %writer20, 0
  br i1 %deref_is_null21, label %deref_null_panic22, label %deref_null_continue23

deref_null_panic22:                               ; preds = %deref_null_continue18
  call void @__wosy_core_system_panic()
  unreachable

deref_null_continue23:                            ; preds = %deref_null_continue18
  %deref24 = inttoptr i32 %writer20 to ptr
  %place25 = load i8, ptr %deref24, align 1
  store i8 %place25, ptr %second, align 1
  %second26 = load i8, ptr %second, align 1
  %call27 = call ptr @wosy_generic____(i8 %second26)
  %call28 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %call27)
  %data30 = getelementptr inbounds i8, ptr %utf8_literal29, i8 0
  store i32 ptrtoint (ptr @wosy_utf8_literal_1 to i32), ptr %data30, align 4
  %length31 = getelementptr inbounds i8, ptr %utf8_literal29, i8 8
  store i64 1, ptr %length31, align 4
  %call32 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %utf8_literal29)
  %storage33 = load i32, ptr %storage, align 4
  %free_pointer = inttoptr i32 %storage33 to ptr
...
define i32 @main() {
entry:
  call void @wosy_fn__706f696e7465722d636173742d636865636b6564__7372632f6d61696e2e77__30613230343433643362333434356136663938666232656564353261383231383861373633306235653561316362333635373438353966343261316164333861__72756e()
  ret i32 0
}
