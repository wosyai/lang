...
@wosy_utf8_literal_2 = private constant [1 x i8] c"\0A"
@wosy_utf8_literal_3 = private constant [1 x i8] c"\0A"

define void @wosy_fn__706f696e7465722d636173742d6469726563742d6465726566__7372632f6d61696e2e77__31346464306661643536626362366663623063663063626463643633653832306561393231306466313563376263613065336534653764353363643764623866__72756e() {
entry:
  %utf8_literal57 = alloca [16 x i8], align 1
  %mutable_field = alloca i8, align 1
  %utf8_literal43 = alloca [16 x i8], align 1
  %shared_field = alloca i8, align 1
  %assignment_value25 = alloca i8, align 1
  %utf8_literal21 = alloca [16 x i8], align 1
  %mutable_scalar = alloca i8, align 1
  %utf8_literal = alloca [16 x i8], align 1
  %shared_scalar = alloca i8, align 1
  ...
  store i32 %allocation_address, ptr %raw, align 4
  %raw1 = load i32, ptr %raw, align 4
  store i32 %raw1, ptr %writer, align 4
  store i8 65, ptr %assignment_value, align 1
  %assignment_value2 = load i8, ptr %assignment_value, align 1
  %writer3 = load i32, ptr %writer, align 4
  %deref_is_null = icmp eq i32 %writer3, 0
...
deref_null_continue:                              ; preds = %entry
  %deref = inttoptr i32 %writer3 to ptr
  %tag = getelementptr inbounds i8, ptr %deref, i8 0
  store i8 %assignment_value2, ptr %tag, align 1
  %raw4 = load i32, ptr %raw, align 4
  %deref_is_null5 = icmp eq i32 %raw4, 0
  br i1 %deref_is_null5, label %deref_null_panic6, label %deref_null_continue7

deref_null_panic6:                                ; preds = %deref_null_continue
  call void @__wosy_core_system_panic()
  unreachable

deref_null_continue7:                             ; preds = %deref_null_continue
  %deref8 = inttoptr i32 %raw4 to ptr
  %place = load i8, ptr %deref8, align 1
  store i8 %place, ptr %shared_scalar, align 1
  %shared_scalar9 = load i8, ptr %shared_scalar, align 1
  ...
  %call10 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %call)
  ...
  %call11 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %utf8_literal)
  %raw12 = load i32, ptr %raw, align 4
  %deref_is_null13 = icmp eq i32 %raw12, 0
  br i1 %deref_is_null13, label %deref_null_panic14, label %deref_null_continue15

deref_null_panic14:                               ; preds = %deref_null_continue7
  call void @__wosy_core_system_panic()
  unreachable

deref_null_continue15:                            ; preds = %deref_null_continue7
  %deref16 = inttoptr i32 %raw12 to ptr
  %place17 = load i8, ptr %deref16, align 1
  store i8 %place17, ptr %mutable_scalar, align 1
  %mutable_scalar18 = load i8, ptr %mutable_scalar, align 1
  %call19 = call ptr @wosy_generic____(i8 %mutable_scalar18)
  %call20 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %call19)
  %data22 = getelementptr inbounds i8, ptr %utf8_literal21, i8 0
  store i32 ptrtoint (ptr @wosy_utf8_literal_1 to i32), ptr %data22, align 4
  %length23 = getelementptr inbounds i8, ptr %utf8_literal21, i8 8
  store i64 1, ptr %length23, align 4
  %call24 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %utf8_literal21)
  store i8 67, ptr %assignment_value25, align 1
  %assignment_value26 = load i8, ptr %assignment_value25, align 1
  %writer27 = load i32, ptr %writer, align 4
  %deref_is_null28 = icmp eq i32 %writer27, 0
  br i1 %deref_is_null28, label %deref_null_panic29, label %deref_null_continue30

deref_null_panic29:                               ; preds = %deref_null_continue15
  call void @__wosy_core_system_panic()
  unreachable

deref_null_continue30:                            ; preds = %deref_null_continue15
  %deref31 = inttoptr i32 %writer27 to ptr
  %tag32 = getelementptr inbounds i8, ptr %deref31, i8 0
  store i8 %assignment_value26, ptr %tag32, align 1
  %raw33 = load i32, ptr %raw, align 4
  %deref_is_null34 = icmp eq i32 %raw33, 0
  br i1 %deref_is_null34, label %deref_null_panic35, label %deref_null_continue36

deref_null_panic35:                               ; preds = %deref_null_continue30
  call void @__wosy_core_system_panic()
  unreachable

deref_null_continue36:                            ; preds = %deref_null_continue30
  %deref37 = inttoptr i32 %raw33 to ptr
  %tag38 = getelementptr inbounds i8, ptr %deref37, i8 0
  %place39 = load i8, ptr %tag38, align 1
  store i8 %place39, ptr %shared_field, align 1
  %shared_field40 = load i8, ptr %shared_field, align 1
  %call41 = call ptr @wosy_generic____(i8 %shared_field40)
  %call42 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %call41)
  %data44 = getelementptr inbounds i8, ptr %utf8_literal43, i8 0
  store i32 ptrtoint (ptr @wosy_utf8_literal_2 to i32), ptr %data44, align 4
  %length45 = getelementptr inbounds i8, ptr %utf8_literal43, i8 8
  store i64 1, ptr %length45, align 4
  %call46 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %utf8_literal43)
  %raw47 = load i32, ptr %raw, align 4
  %deref_is_null48 = icmp eq i32 %raw47, 0
  br i1 %deref_is_null48, label %deref_null_panic49, label %deref_null_continue50

deref_null_panic49:                               ; preds = %deref_null_continue36
  call void @__wosy_core_system_panic()
  unreachable

deref_null_continue50:                            ; preds = %deref_null_continue36
  %deref51 = inttoptr i32 %raw47 to ptr
  %tag52 = getelementptr inbounds i8, ptr %deref51, i8 0
  %place53 = load i8, ptr %tag52, align 1
  store i8 %place53, ptr %mutable_field, align 1
  %mutable_field54 = load i8, ptr %mutable_field, align 1
  %call55 = call ptr @wosy_generic____(i8 %mutable_field54)
  %call56 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %call55)
  %data58 = getelementptr inbounds i8, ptr %utf8_literal57, i8 0
  store i32 ptrtoint (ptr @wosy_utf8_literal_3 to i32), ptr %data58, align 4
  %length59 = getelementptr inbounds i8, ptr %utf8_literal57, i8 8
  store i64 1, ptr %length59, align 4
  %call60 = call { i64, i1 } @wosy_fn__737464__7372632f626f6f7473747261702e77__34366235313639353366343431376238663133323532353962656662653664653363343164653731363665313933393934633238336632383738373430643631__7072696e74(ptr %utf8_literal57)
  %raw61 = load i32, ptr %raw, align 4
  %free_pointer = inttoptr i32 %raw61 to ptr
...
define i32 @main() {
entry:
  call void @wosy_fn__706f696e7465722d636173742d6469726563742d6465726566__7372632f6d61696e2e77__31346464306661643536626362366663623063663063626463643633653832306561393231306466313563376263613065336534653764353363643764623866__72756e()
  ret i32 0
}
